...
cp $QT_ROOT_DIR/bin/Qt6Concurrent.dll $EXE_APP_DIR/
cp $QT_ROOT_DIR/bin/Qt6Core.dll $EXE_APP_DIR/
cp $QT_ROOT_DIR/bin/Qt6Core5Compat.dll $EXE_APP_DIR/
cp $QT_ROOT_DIR/bin/Qt6DBus.dll $EXE_APP_DIR/
cp $QT_ROOT_DIR/bin/Qt6Gui.dll $EXE_APP_DIR/
cp $QT_ROOT_DIR/bin/Qt6Multimedia.dll $EXE_APP_DIR/
cp $QT_ROOT_DIR/bin/Qt6Network.dll $EXE_APP_DIR/
cp $QT_ROOT_DIR/bin/Qt6PrintSupport.dll $EXE_APP_DIR/
cp $QT_ROOT_DIR/bin/Qt6Sql.dll $EXE_APP_DIR/
cp $QT_ROOT_DIR/bin/Qt6Svg.dll $EXE_APP_DIR/
cp $QT_ROOT_DIR/bin/Qt6WebSockets.dll $EXE_APP_DIR/
cp $QT_ROOT_DIR/bin/Qt6Widgets.dll $EXE_APP_DIR/
cp $QT_ROOT_DIR/bin/Qt6Xml.dll $EXE_APP_DIR/
#
# Copy Qt plugins
#
mkdir $EXE_APP_DIR/generic
cp $QT_ROOT_DIR/plugins/generic/qtuiotouchplugin.dll $EXE_APP_DIR/audio/
...
cp $QT_ROOT_DIR/plugins/multimedia/ffmpegmediaplugin.dll $EXE_APP_DIR/multimedia/
cp $QT_ROOT_DIR/plugins/multimedia/windowsmediaplugin.dll $EXE_APP_DIR/multimedia/
mkdir $EXE_APP_DIR/networkinformation
cp $QT_ROOT_DIR/plugins/networkinformation/qnetworklistmanager.dll $EXE_APP_DIR/networkinformation/
...
cp $QT_ROOT_DIR/plugins/styles/qmodernwindowsstyle.dll $EXE_APP_DIR/styles/
mkdir $EXE_APP_DIR/tls
cp $QT_ROOT_DIR/plugins/tls/qcertonlybackend.dll $EXE_APP_DIR/tls/
cp $QT_ROOT_DIR/plugins/tls/qopensslbackend.dll $EXE_APP_DIR/tls/
cp $QT_ROOT_DIR/plugins/tls/qschannelbackend.dll $EXE_APP_DIR/tls/
#
# Copy openssl lib
#

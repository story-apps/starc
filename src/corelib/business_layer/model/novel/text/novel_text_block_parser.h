 ...
 */
class CORE_LIBRARY_EXPORT NovelCharacterParser
{
public:
    /**
...
public:
     ...
     */
    static NovelCharacterParser::Section section(const QString& _text);
 ...
 */
class CORE_LIBRARY_EXPORT NovelSceneHeadingParser
{
public:
    /**
...
public:
     ...
     * @brief Получить секцию блока
     */
    static NovelSceneHeadingParser::Section section(const QString& _text);
 ...
 */
class CORE_LIBRARY_EXPORT NovelSceneCharactersParser
{
public:
    /**

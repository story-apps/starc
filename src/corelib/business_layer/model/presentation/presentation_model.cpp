...
void PresentationModel::setContent(const QByteArray& _imagesArchive, const QVector<QSize>& _sizes)
{
    ...
    //
    d->imagesArchiveUuid
        = rawDataWrapper()->save(_imagesArchive, Domain::DocumentObjectType::BinaryData);
...
QUuid PresentationModel::loadImagesAsync(int _from, int _amount)
{
    ...
    QtConcurrent::run([this, queryUuid, _from, _amount]() {
        ...
        QMetaObject::invokeMethod(
            this,
            [this, queryUuid, images, _from]() { emit imagesLoaded(queryUuid, images, _from); },
            Qt::QueuedConnection);
    });

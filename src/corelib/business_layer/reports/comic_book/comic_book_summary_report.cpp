...
void ComicBookSummaryReport::build(QAbstractItemModel* _model)
{
    ...
    //
    {
            ...
            for (const auto& time : sceneTimes) {
                auto timeName
                    = createModelItem(time.isEmpty() ? QCoreApplication::translate(
                                          "BusinessLogic::ComicBookSummaryReport", "[UNDEFINED]")
                                                     : time);
        ...
        d->scenesInfoModel->setHeaderData(
            0, Qt::Horizontal,
            QCoreApplication::translate("BusinessLayer::ComicBookSummaryReport", "Scene time"),
            Qt::DisplayRole);
        d->scenesInfoModel->setHeaderData(
            1, Qt::Horizontal,
            QCoreApplication::translate("BusinessLayer::ComicBookSummaryReport", "Occurrences"),
    ...
    //
    {
        ...
        d->locationsInfoModel->setHeaderData(
            0, Qt::Horizontal,
            QCoreApplication::translate("BusinessLayer::ComicBookSummaryReport", "Scene intro"),
            Qt::DisplayRole);
        d->locationsInfoModel->setHeaderData(
            1, Qt::Horizontal,
            QCoreApplication::translate("BusinessLayer::ComicBookSummaryReport", "Occurrences"),
    ...
    //
    {
        ...
        addCharacterItemToReport(QCoreApplication::translate(
                                     "BusinessLogic::ComicBookSummaryReport", "About 10 dialogues"),
                                 speakAbout10);
        addCharacterItemToReport(
            QCoreApplication::translate("BusinessLogic::ComicBookSummaryReport", "Nonspeaking"),
            nonspeaking);
        //
        d->charactersInfoModel->setHeaderData(
            0, Qt::Horizontal,
            QCoreApplication::translate("BusinessLayer::ComicBookSummaryReport", "Character type"),
            Qt::DisplayRole);
        d->charactersInfoModel->setHeaderData(
            1, Qt::Horizontal,
            QCoreApplication::translate("BusinessLayer::ComicBookSummaryReport", "Occurrences"),

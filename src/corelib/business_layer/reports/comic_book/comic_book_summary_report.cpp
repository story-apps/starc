...
void ComicBookSummaryReport::build(QAbstractItemModel* _model)
{
    ...
    //                          auto& paragraphCounters =
    //                          paragraphsToCounters[textItem->paragraphType()];
    //                          ++paragraphCounters.occurrences;
    //                          const auto paragraphWords =
    //                          TextHelper::wordsCount(textItem->text()); paragraphCounters.words +=
    //                          paragraphWords; totalWords += paragraphWords;
    ...
    //        d->textInfoModel->setHeaderData(
    //            2, Qt::Horizontal,
    //            QCoreApplication::translate("BusinessLayer::ComicBookSummaryReport",
    //            "Occurrences"), Qt::DisplayRole);
    //        d->textInfoModel->setHeaderData(
    //            3, Qt::Horizontal,
    ...
    //            const QString time = PanelParser::sceneTime(scene);
    ...
    //                                          "BusinessLogic::ComicBookSummaryReport",
    //                                          "[UNDEFINED]")
    //                                                     : time);
    ...
    //            0, Qt::Horizontal,
    //            QCoreApplication::translate("BusinessLayer::ComicBookSummaryReport", "Scene
    //            time"), Qt::DisplayRole);
    //        d->scenesInfoModel->setHeaderData(
    //            1, Qt::Horizontal,
    //            QCoreApplication::translate("BusinessLayer::ComicBookSummaryReport",
    ...
    //        for (const auto& scene : scenes) {
    //            const auto place = PanelParser::sceneIntro(scene);
    ...
    //                                         &totalCount, &index](const QString& _name, int
    //                                         _count) {
    ...
    //            QCoreApplication::translate("BusinessLogic::ComicBookSummaryReport",
    //                                        "More then 10 dialogues"),
    //            speakMore10);
    //        addCharacterItemToReport(QCoreApplication::translate(
    //                                     "BusinessLogic::ComicBookSummaryReport", "About 10
    //                                     dialogues"),
    //                                 speakAbout10);
    //        addCharacterItemToReport(
    //            QCoreApplication::translate("BusinessLogic::ComicBookSummaryReport",
    ...
    //            0, Qt::Horizontal,
    //            QCoreApplication::translate("BusinessLayer::ComicBookSummaryReport", "Character
    //            type"), Qt::DisplayRole);
    //        d->charactersInfoModel->setHeaderData(
    //            1, Qt::Horizontal,
    //            QCoreApplication::translate("BusinessLayer::ComicBookSummaryReport",
...
std::chrono::milliseconds ComicBookSummaryReport::duration() const
{
    return d->duration;
}
...
QAbstractItemModel* ComicBookSummaryReport::scenesInfoModel() const
{
    return d->scenesInfoModel.data();
}

QAbstractItemModel* ComicBookSummaryReport::locationsInfoModel() const
{
    return d->locationsInfoModel.data();
}

QAbstractItemModel* ComicBookSummaryReport::charactersInfoModel() const
{

#include "screenplay_series_cast_report.h"
...
class ScreenplaySeriesCastReport::Implementation
{
public:
    /**
...
ScreenplaySeriesCastReport::ScreenplaySeriesCastReport()
    : d(new Implementation)
{
}

ScreenplaySeriesCastReport::~ScreenplaySeriesCastReport() = default;

bool ScreenplaySeriesCastReport::isValid() const
{
    return d->castModel->rowCount() > 0;
}

void ScreenplaySeriesCastReport::build(QAbstractItemModel* _model)
{
    if (_model == nullptr) {
        return;
    }
...
void ScreenplaySeriesCastReport::setParameters(bool _showSceneDetails, bool _showWords, int _sortBy)
{
...
QAbstractItemModel* ScreenplaySeriesCastReport::castModel() const
{
    return d->castModel.data();
}

void ScreenplaySeriesCastReport::saveToPdf(const QString& _fileName) const
{
...
void ScreenplaySeriesCastReport::saveToXlsx(const QString& _fileName) const
{
    QXlsx::Document xlsx;

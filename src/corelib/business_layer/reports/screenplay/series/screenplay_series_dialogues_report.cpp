#include "screenplay_series_dialogues_report.h"
...
class ScreenplaySeriesDialoguesReport::Implementation
{
public:
    /**
...
ScreenplaySeriesDialoguesReport::ScreenplaySeriesDialoguesReport()
    : d(new Implementation)
{
}

ScreenplaySeriesDialoguesReport::~ScreenplaySeriesDialoguesReport() = default;

bool ScreenplaySeriesDialoguesReport::isValid() const
{
    return d->dialoguesModel->rowCount() > 0;
}

void ScreenplaySeriesDialoguesReport::build(QAbstractItemModel* _model)
{
    if (_model == nullptr) {
        return;
    }
...
void ScreenplaySeriesDialoguesReport::setParameters(const QVector<QString>& _characters)
{
    d->visibleCharacters = _characters;
}

QAbstractItemModel* ScreenplaySeriesDialoguesReport::dialoguesModel() const
{
    return d->dialoguesModel.data();
}

QVector<QString> ScreenplaySeriesDialoguesReport::characters() const
{
    return d->characters;
}

void ScreenplaySeriesDialoguesReport::saveToPdf(const QString& _fileName) const
{
    ...
    cursor.insertText(
        QString("%1 - %2").arg(d->episodesModel->informationModel()->name(),
...
void ScreenplaySeriesDialoguesReport::saveToXlsx(const QString& _fileName) const
{
    QXlsx::Document xlsx;

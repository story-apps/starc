 ...
 */
class CORE_LIBRARY_EXPORT ScreenplaySeriesCharactersActivityPlot : public AbstractPlot
{
public:
    ScreenplaySeriesCharactersActivityPlot();
    ~ScreenplaySeriesCharactersActivityPlot() override;

#include "characters_pdf_exporter.h"


namespace BusinessLayer {

CharactersPdfExporter::CharactersPdfExporter()
    : CharactersExporter()
    , AbstractPdfExporter()
{
}

void CharactersPdfExporter::updateExportOptions(AbstractModel* _model,
...
void CharactersPdfExporter::printBlockDecorations(

...
class NovelTextCorrector::Implementation
{
public:
    explicit Implementation(NovelTextCorrector* _q);
...
NovelTextCorrector::Implementation::Implementation(NovelTextCorrector* _q)
    : q(_q)
{
}

QTextDocument* NovelTextCorrector::Implementation::document() const
{
    return q->document();
}
            ...
            if (cursor.hasSelection()) {
                ...
                if (cursor.block().text().isEmpty()) {
                    ...
                    const auto blockStyle
                        = TemplatesFacade::novelTemplate(q->templateId()).paragraphStyle(blockType);
...
void NovelTextCorrector::Implementation::moveCurrentBlockWithThreePreviousToNextPage(
...
void NovelTextCorrector::Implementation::moveCurrentBlockWithTwoPreviousToNextPage(
...
void NovelTextCorrector::Implementation::moveCurrentBlockWithPreviousToNextPage(
    const QTextBlock& _previousBlock, qreal _pageHeight, qreal _pageWidth, TextCursor& _cursor,
    QTextBlock& _block, qreal& _lastBlockHeight)
{
    --currentBlockInfo.number;
...
void NovelTextCorrector::Implementation::moveCurrentBlockToNextPage(
...
QTextBlock NovelTextCorrector::Implementation::findPreviousBlock(const QTextBlock& _block)
{
...
QTextBlock NovelTextCorrector::Implementation::findNextBlock(const QTextBlock& _block)
{
...
void NovelTextCorrector::Implementation::moveBlockToNextPage(const QTextBlock& _block,
...
NovelTextCorrector::NovelTextCorrector(QTextDocument* _document)
...
NovelTextCorrector::~NovelTextCorrector() = default;

void NovelTextCorrector::setCorrectionOptions(const QStringList& _options)
{
...
void NovelTextCorrector::makeCorrections(int _position, int _charsChanged)
{

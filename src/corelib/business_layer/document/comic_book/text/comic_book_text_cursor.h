 ...
 */
class CORE_LIBRARY_EXPORT ComicBookTextCursor : public QTextCursor
{
public:
    ComicBookTextCursor();
    ComicBookTextCursor(const QTextCursor& other);
    explicit ComicBookTextCursor(QTextDocument* _document);
    ~ComicBookTextCursor();

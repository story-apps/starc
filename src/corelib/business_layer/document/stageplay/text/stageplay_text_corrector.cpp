...
class StageplayTextCorrector::Implementation
{
public:
    explicit Implementation(StageplayTextCorrector* _q);
    ...
    StageplayTextCorrector* q = nullptr;
...
StageplayTextCorrector::Implementation::Implementation(StageplayTextCorrector* _q)
    : q(_q)
{
}

QTextDocument* StageplayTextCorrector::Implementation::document() const
{
    return q->document();
}

void StageplayTextCorrector::Implementation::updateBlocksVisibility(int _from, int _charsChanged)
{
    //
    // Пробегаем документ и настраиваем видимые и невидимые блоки в соответствии с шаблоном
    //
    const auto& currentTemplate = TemplatesFacade::stageplayTemplate(q->templateId());
...
void StageplayTextCorrector::Implementation::clearCharacterNamesCorrections()
{
    //
...
void StageplayTextCorrector::Implementation::correctPageBreaks(int _position)
{
    return;
...
void StageplayTextCorrector::Implementation::moveCurrentBlockWithThreePreviousToNextPage(
...
void StageplayTextCorrector::Implementation::moveCurrentBlockWithTwoPreviousToNextPage(
...
void StageplayTextCorrector::Implementation::moveCurrentBlockWithPreviousToNextPage(
    const QTextBlock& _previousBlock, qreal _pageHeight, qreal _pageWidth, TextCursor& _cursor,
    QTextBlock& _block, qreal& _lastBlockHeight)
{
    --currentBlockInfo.number;
...
void StageplayTextCorrector::Implementation::moveCurrentBlockToNextPage(
...
void StageplayTextCorrector::Implementation::breakDialogue(const QTextBlockFormat& _blockFormat,
                                                           ...
                                                           qreal& _lastBlockHeight)
{
    ...
    if (characterBlock.isValid()) {
        ...
        const QString characterName
            = BusinessLayer::StageplayCharacterParser::name(characterBlock.text());
...
QTextBlock StageplayTextCorrector::Implementation::findPreviousBlock(const QTextBlock& _block)
{
...
QTextBlock StageplayTextCorrector::Implementation::findNextBlock(const QTextBlock& _block)
{
...
void StageplayTextCorrector::Implementation::moveBlockToNextPage(const QTextBlock& _block,
...
QString StageplayTextCorrector::continuedTerm()
{
    return QString(" (%1)").arg(
        QApplication::translate("BusinessLogic::ScriptTextCorrector", kContinuedTerm));
}

StageplayTextCorrector::StageplayTextCorrector(QTextDocument* _document)
...
StageplayTextCorrector::~StageplayTextCorrector() = default;

void StageplayTextCorrector::setCorrectionOptions(const QStringList& _options)
{

...
const QHash<DocumentObjectType, QByteArray> kDocumentObjectTypeToMimeType
    = {{ DocumentObjectType::Undefined, "application/x-starc/document/undefined" },
       ...
       { DocumentObjectType::ScreenplayTreatment, "application/x-starc/document/screenplay/treatment" },
       ...
       { DocumentObjectType::ScreenplayStatistics, "application/x-starc/document/screenplay/statistics" },

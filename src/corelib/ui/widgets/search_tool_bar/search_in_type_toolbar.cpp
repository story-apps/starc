#include "search_in_type_toolbar.h"
...
class SearchInTypeToolbar::Implementation
{
public:
     ...
     */
    void showPopup(SearchInTypeToolbar* _parent);
...
SearchInTypeToolbar::Implementation::Implementation(QWidget* _parent)
...
void SearchInTypeToolbar::Implementation::showPopup(SearchInTypeToolbar* _parent)
{
...
SearchInTypeToolbar::SearchInTypeToolbar(QWidget* _parent)
    : SearchToolbar(_parent)
...
//    setFocusProxy(d->searchText);
    ...
    connect(d->goToPreviousAction, &QAction::triggered, this,
            &SearchInTypeToolbar::findPreviousRequested);
    d->goToNextAction->setIconText(u8"\U000f0140");
    d->goToNextAction->setShortcut(QKeySequence::FindNext);
    addAction(d->goToNextAction);
    connect(d->goToNextAction, &QAction::triggered, this, &SearchInTypeToolbar::findNextRequested);
    ...
    connect(d->matchCaseAction, &QAction::toggled, this, &SearchInTypeToolbar::findTextRequested);
    //
    ...
    connect(d->replace, &Button::clicked, this, &SearchInTypeToolbar::replaceOnePressed);
    addAction(d->replaceAllAction);
    connect(d->replaceAll, &Button::clicked, this, &SearchInTypeToolbar::replaceAllPressed);
}

SearchInTypeToolbar::~SearchInTypeToolbar() = default;

int SearchInTypeToolbar::searchInType() const
{
    return d->popup->currentIndex().row();
}

bool SearchInTypeToolbar::canAnimateHoverOut() const
{
    return !d->popup->isVisible();
}

void SearchInTypeToolbar::updateTranslations()
{
...
void SearchInTypeToolbar::designSystemChangeEvent(DesignSystemChangeEvent* _event)
{

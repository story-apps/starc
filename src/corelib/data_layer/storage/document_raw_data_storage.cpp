...
QUuid DocumentRawDataStorage::save(const QByteArray& _data, Domain::DocumentObjectType _type)
{
    if (_data.isEmpty()) {
        return {};
    }
    ...
    //
    // Сохраним документ во временный буфер
    //
    ...
    // ... положим в хранилище
    //
    auto document = StorageFacade::documentStorage()->createDocument(uuid, _type);

...
LanguageDialog::Implementation::Implementation(QWidget* _parent)
    : arabic(new PercentRadioButton(_parent, 18))
    , azerbaijani(new PercentRadioButton(_parent, 95))
    , belarusian(new PercentRadioButton(_parent, 53))
    , catalan(new PercentRadioButton(_parent, 87))
    , chinese(new PercentRadioButton(_parent, 6))
    , croatian(new PercentRadioButton(_parent, 74))
    , danish(new PercentRadioButton(_parent, 96))
    ...
    , galician(new PercentRadioButton(_parent, 74))
    , german(new PercentRadioButton(_parent, 71))
    , hebrew(new PercentRadioButton(_parent, 88))
    , hindi(new PercentRadioButton(_parent, 39))
    , hungarian(new PercentRadioButton(_parent, 37))
    , indonesian(new PercentRadioButton(_parent, 10))
    , italian(new PercentRadioButton(_parent, 31))
    , korean(new PercentRadioButton(_parent, 82))
    , persian(new PercentRadioButton(_parent, 68))
    , polish(new PercentRadioButton(_parent, 43))
    , portuguese(new PercentRadioButton(_parent, 14))
    , portugueseBrazil(new PercentRadioButton(_parent, 72))
    , romanian(new PercentRadioButton(_parent, 67))
    ...
    , tamil(new PercentRadioButton(_parent, 49))

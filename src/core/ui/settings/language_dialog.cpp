...
LanguageDialog::Implementation::Implementation(QWidget* _parent)
    ...
    , belarusian(new PercentRadioButton(_parent, 44))
    , catalan(new PercentRadioButton(_parent, 68))
    , chinese(new PercentRadioButton(_parent, 87))
    , croatian(new PercentRadioButton(_parent, 47))
    , danish(new PercentRadioButton(_parent, 77))
    ...
    , galician(new PercentRadioButton(_parent, 48))
    , german(new PercentRadioButton(_parent, 93))
    , hebrew(new PercentRadioButton(_parent, 78))
    ...
    , korean(new PercentRadioButton(_parent, 52))
    , persian(new PercentRadioButton(_parent, 54))
    ...
    , romanian(new PercentRadioButton(_parent, 43))
    , russian(new PercentRadioButton(_parent, 100))
    , slovenian(new PercentRadioButton(_parent, 100))
    , spanish(new PercentRadioButton(_parent, 72))
    , swedish(new PercentRadioButton(_parent, 16))
    ...
    , turkish(new PercentRadioButton(_parent, 92))

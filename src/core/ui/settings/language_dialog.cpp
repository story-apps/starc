...
LanguageDialog::Implementation::Implementation(QWidget* _parent)
    : arabic(new PercentRadioButton(_parent, 95))
    , azerbaijani(new PercentRadioButton(_parent, 98))
    , belarusian(new PercentRadioButton(_parent, 45))
    , catalan(new PercentRadioButton(_parent, 81))
    , chinese(new PercentRadioButton(_parent, 5))
    , croatian(new PercentRadioButton(_parent, 62))
    , danish(new PercentRadioButton(_parent, 93))
    ...
    , french(new PercentRadioButton(_parent, 58))
    , galician(new PercentRadioButton(_parent, 62))
    , german(new PercentRadioButton(_parent, 100))
    , hebrew(new PercentRadioButton(_parent, 97))
    , hindi(new PercentRadioButton(_parent, 32))
    , hungarian(new PercentRadioButton(_parent, 32))
    , indonesian(new PercentRadioButton(_parent, 9))
    , italian(new PercentRadioButton(_parent, 52))
    , korean(new PercentRadioButton(_parent, 69))
    , persian(new PercentRadioButton(_parent, 63))
    , polish(new PercentRadioButton(_parent, 45))
    , portuguese(new PercentRadioButton(_parent, 12))
    , portugueseBrazil(new PercentRadioButton(_parent, 83))
    , romanian(new PercentRadioButton(_parent, 56))
    , russian(new PercentRadioButton(_parent, 100))
    , slovenian(new PercentRadioButton(_parent, 100))
    , spanish(new PercentRadioButton(_parent, 79))
    , tagalog(new PercentRadioButton(_parent, 19))
    , tamil(new PercentRadioButton(_parent, 41))

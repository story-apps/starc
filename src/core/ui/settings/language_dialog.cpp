...
LanguageDialog::Implementation::Implementation(QWidget* _parent)
    ...
    , danish(new PercentRadioButton(_parent, 74))
    ...
    , italian(new PercentRadioButton(_parent, 42))
    , korean(new PercentRadioButton(_parent, 50))
    , persian(new PercentRadioButton(_parent, 52))
    , polish(new PercentRadioButton(_parent, 97))
    , portuguese(new PercentRadioButton(_parent, 9))
    , portugueseBrazil(new PercentRadioButton(_parent, 100))
    , romanian(new PercentRadioButton(_parent, 42))
    ...
    , tamil(new PercentRadioButton(_parent, 33))

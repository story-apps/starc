...
LanguageDialog::Implementation::Implementation(QWidget* _parent)
    ...
    , belarusian(new PercentRadioButton(_parent, 58))
    , catalan(new PercentRadioButton(_parent, 90))
    , chinese(new PercentRadioButton(_parent, 7))
    , croatian(new PercentRadioButton(_parent, 73))
    , danish(new PercentRadioButton(_parent, 95))
    ...
    , german(new PercentRadioButton(_parent, 79))
    , hebrew(new PercentRadioButton(_parent, 96))
    , hindi(new PercentRadioButton(_parent, 43))
    , hungarian(new PercentRadioButton(_parent, 41))
    , indonesian(new PercentRadioButton(_parent, 12))
    , italian(new PercentRadioButton(_parent, 35))
    , korean(new PercentRadioButton(_parent, 91))
    , persian(new PercentRadioButton(_parent, 75))
    , polish(new PercentRadioButton(_parent, 49))
    , portuguese(new PercentRadioButton(_parent, 15))
    , portugueseBrazil(new PercentRadioButton(_parent, 80))
    , romanian(new PercentRadioButton(_parent, 73))
    , russian(new PercentRadioButton(_parent, 100))
    , slovenian(new PercentRadioButton(_parent, 100))
    , spanish(new PercentRadioButton(_parent, 100))

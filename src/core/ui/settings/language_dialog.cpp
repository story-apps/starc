...
LanguageDialog::Implementation::Implementation(QWidget* _parent)
    : arabic(new PercentRadioButton(_parent, 20))
    , azerbaijani(new PercentRadioButton(_parent, 100))
    , belarusian(new PercentRadioButton(_parent, 60))
    , catalan(new PercentRadioButton(_parent, 81))
    , chinese(new PercentRadioButton(_parent, 7))
    , croatian(new PercentRadioButton(_parent, 75))
    , danish(new PercentRadioButton(_parent, 97))
    , english(new PercentRadioButton(_parent, 100))
    , esperanto(new PercentRadioButton(_parent, 11))
    , french(new PercentRadioButton(_parent, 77))
    , galician(new PercentRadioButton(_parent, 83))
    , german(new PercentRadioButton(_parent, 80))
    , hebrew(new PercentRadioButton(_parent, 97))
    , hindi(new PercentRadioButton(_parent, 44))
    , hungarian(new PercentRadioButton(_parent, 42))
    , indonesian(new PercentRadioButton(_parent, 12))
    , italian(new PercentRadioButton(_parent, 35))
    , korean(new PercentRadioButton(_parent, 92))
    , persian(new PercentRadioButton(_parent, 76))
    , polish(new PercentRadioButton(_parent, 38))
    , portuguese(new PercentRadioButton(_parent, 15))
    , portugueseBrazil(new PercentRadioButton(_parent, 80))
    , romanian(new PercentRadioButton(_parent, 75))
    , russian(new PercentRadioButton(_parent, 100))
    , slovenian(new PercentRadioButton(_parent, 100))
    , spanish(new PercentRadioButton(_parent, 96))
    , tagalog(new PercentRadioButton(_parent, 22))
    , tamil(new PercentRadioButton(_parent, 54))

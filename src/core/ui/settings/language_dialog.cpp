...
LanguageDialog::Implementation::Implementation(QWidget* _parent)
    ...
    , belarusian(new PercentRadioButton(_parent, 39))
    , catalan(new PercentRadioButton(_parent, 65))
    , chinese(new PercentRadioButton(_parent, 80))
    , croatian(new PercentRadioButton(_parent, 42))
    ...
    , french(new PercentRadioButton(_parent, 99))
    , galician(new PercentRadioButton(_parent, 44))
    , german(new PercentRadioButton(_parent, 88))
    , greek(new PercentRadioButton(_parent, 99))
    , hebrew(new PercentRadioButton(_parent, 73))
    , hindi(new PercentRadioButton(_parent, 24))
    , hungarian(new PercentRadioButton(_parent, 27))
    , indonesian(new PercentRadioButton(_parent, 99))
    , italian(new PercentRadioButton(_parent, 51))
    , korean(new PercentRadioButton(_parent, 46))
    , persian(new PercentRadioButton(_parent, 50))
    , polish(new PercentRadioButton(_parent, 91))
    , portuguese(new PercentRadioButton(_parent, 16))
    , portugueseBrazil(new PercentRadioButton(_parent, 99))
    , romanian(new PercentRadioButton(_parent, 38))
    , russian(new PercentRadioButton(_parent, 100))
    , slovenian(new PercentRadioButton(_parent, 99))
    , spanish(new PercentRadioButton(_parent, 91))
    , swedish(new PercentRadioButton(_parent, 32))
    , tamil(new PercentRadioButton(_parent, 30))
    , telugu(new PercentRadioButton(_parent, 93))
    , turkish(new PercentRadioButton(_parent, 85))

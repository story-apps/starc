...
LanguageDialog::Implementation::Implementation(QWidget* _parent)
    : arabic(new PercentRadioButton(_parent, 78))
    , armenian(new PercentRadioButton(_parent, 13))
    , azerbaijani(new PercentRadioButton(_parent, 80))
    , belarusian(new PercentRadioButton(_parent, 45))
    , catalan(new PercentRadioButton(_parent, 69))
    , chinese(new PercentRadioButton(_parent, 88))
    , croatian(new PercentRadioButton(_parent, 48))
    ...
    , french(new PercentRadioButton(_parent, 76))
    , galician(new PercentRadioButton(_parent, 49))
    , german(new PercentRadioButton(_parent, 94))
    , hebrew(new PercentRadioButton(_parent, 79))
    , hindi(new PercentRadioButton(_parent, 26))
    , hungarian(new PercentRadioButton(_parent, 24))
    , indonesian(new PercentRadioButton(_parent, 7))
    , italian(new PercentRadioButton(_parent, 43))
    , korean(new PercentRadioButton(_parent, 53))
    , persian(new PercentRadioButton(_parent, 55))
    , polish(new PercentRadioButton(_parent, 100))
    , portuguese(new PercentRadioButton(_parent, 10))
    , portugueseBrazil(new PercentRadioButton(_parent, 100))
    , romanian(new PercentRadioButton(_parent, 44))
    , russian(new PercentRadioButton(_parent, 100))
    , slovenian(new PercentRadioButton(_parent, 100))
    , spanish(new PercentRadioButton(_parent, 73))
    , swedish(new PercentRadioButton(_parent, 15))
    , tagalog(new PercentRadioButton(_parent, 13))
    , tamil(new PercentRadioButton(_parent, 35))
    , telugu(new PercentRadioButton(_parent, 100))

...
LanguageDialog::Implementation::Implementation(QWidget* _parent)
    : arabic(new PercentRadioButton(_parent, 76))
    , armenian(new PercentRadioButton(_parent, 13))
    , azerbaijani(new PercentRadioButton(_parent, 79))
    , belarusian(new PercentRadioButton(_parent, 43))
    , catalan(new PercentRadioButton(_parent, 68))
    , chinese(new PercentRadioButton(_parent, 87))
    , croatian(new PercentRadioButton(_parent, 45))
    ...
    , swedish(new PercentRadioButton(_parent, 31))

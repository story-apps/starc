...
LanguageDialog::Implementation::Implementation(QWidget* _parent)
    ...
    , azerbaijani(new PercentRadioButton(_parent, 96))
    ...
    , croatian(new PercentRadioButton(_parent, 72))
    ...
    , galician(new PercentRadioButton(_parent, 72))
    , german(new PercentRadioButton(_parent, 69))
    , hebrew(new PercentRadioButton(_parent, 85))
    ...
    , italian(new PercentRadioButton(_parent, 30))
    , korean(new PercentRadioButton(_parent, 79))
    , persian(new PercentRadioButton(_parent, 66))
    , polish(new PercentRadioButton(_parent, 42))
    , portuguese(new PercentRadioButton(_parent, 13))
    , portugueseBrazil(new PercentRadioButton(_parent, 69))
    , romanian(new PercentRadioButton(_parent, 65))
    ...
    , tamil(new PercentRadioButton(_parent, 47))
    , turkish(new PercentRadioButton(_parent, 96))

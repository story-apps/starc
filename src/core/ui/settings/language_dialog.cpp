...
LanguageDialog::Implementation::Implementation(QWidget* _parent)
    : arabic(new PercentRadioButton(_parent, 90))
    ...
    , danish(new PercentRadioButton(_parent, 89))
    ...
    , german(new PercentRadioButton(_parent, 97))
    ...
    , portugueseBrazil(new PercentRadioButton(_parent, 78))
    ...
    , spanish(new PercentRadioButton(_parent, 75))

...
void OnboardingNavigator::Implementation::initUiPage()
{
    ...
    addLanguage("Azərbaycan", QLocale::Azerbaijani, 90);
    addLanguage("Беларуский", QLocale::Belarusian, 51);
    addLanguage("Català", QLocale::Catalan, 76);
    addLanguage("Dansk", QLocale::Danish, 85);
    addLanguage("Deutsch", QLocale::German, 98);
    ...
    addLanguage("Tagalog", QLocale::Filipino, 16);
    addLanguage("Türkçe", QLocale::Turkish, 95);
    addLanguage("Українська", QLocale::Ukrainian, 98);
    addLanguage("اَلْعَرَبِيَّةُ", QLocale::Arabic, 87);
    addLanguage("فارسی", QLocale::Persian, 62);
    addLanguage("עִבְרִית", QLocale::Hebrew, 88);
    addLanguage("हिन्दी", QLocale::Hindi, 29);
    addLanguage("தமிழ்", QLocale::Tamil, 37);
    addLanguage("తెలుగు", QLocale::Telugu, 98);
    addLanguage("汉语", QLocale::Chinese, 5);
    addLanguage("한국어", QLocale::Korean, 60);

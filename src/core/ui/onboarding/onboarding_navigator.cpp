...
void OnboardingNavigator::Implementation::initUiPage()
{
    ...
    addLanguage("Azərbaycan", QLocale::Azerbaijani, 80);
    addLanguage("Беларуский", QLocale::Belarusian, 44);
    addLanguage("Català", QLocale::Catalan, 68);
    addLanguage("Dansk", QLocale::Danish, 77);
    addLanguage("Deutsch", QLocale::German, 93);
    auto englishItem = addLanguage("English", QLocale::English, 100);
    addLanguage("Español", QLocale::Spanish, 72);
    addLanguage("Esperanto", QLocale::Esperanto, 7);
    addLanguage("Français", QLocale::French, 75);
    addLanguage("Galego", QLocale::Galician, 48);
    addLanguage("Hrvatski", QLocale::Croatian, 47);
    addLanguage("Indonesian", QLocale::Indonesian, 7);
    addLanguage("Italiano", QLocale::Italian, 43);
    addLanguage("Magyar", QLocale::Hungarian, 24);
    ...
    addLanguage("Português Brasileiro", QLocale::Portuguese, 100);
    addLanguage("Română", QLocale::Romanian, 43);
    addLanguage("Русский", QLocale::Russian, 100);
    addLanguage("Slovenski", QLocale::Slovenian, 100);
    addLanguage("Svenska", QLocale::Swedish, 16);
    addLanguage("Tagalog", QLocale::Filipino, 13);
    addLanguage("Türkçe", QLocale::Turkish, 92);
    addLanguage("Українська", QLocale::Ukrainian, 100);
    addLanguage("اَلْعَرَبِيَّةُ", QLocale::Arabic, 78);
    addLanguage("فارسی", QLocale::Persian, 54);
    addLanguage("עִבְרִית", QLocale::Hebrew, 78);
    addLanguage("हिन्दी", QLocale::Hindi, 26);
    addLanguage("தமிழ்", QLocale::Tamil, 34);
    addLanguage("తెలుగు", QLocale::Telugu, 100);
    addLanguage("Հայերեն", QLocale::Armenian, 13);
    addLanguage("汉语", QLocale::Chinese, 87);
    addLanguage("한국어", QLocale::Korean, 52);

...
void OnboardingNavigator::Implementation::initUiPage()
{
    ...
    addLanguage("Azərbaycan", QLocale::Azerbaijani, 79);
    addLanguage("Беларуский", QLocale::Belarusian, 43);
    ...
    addLanguage("Hrvatski", QLocale::Croatian, 45);
    ...
    addLanguage("Svenska", QLocale::Swedish, 31);

...
void OnboardingNavigator::Implementation::initUiPage()
{
    ...
    addLanguage("Azərbaycan", QLocale::Azerbaijani, 82);
    ...
    addLanguage("Français", QLocale::French, 78);
    addLanguage("Galego", QLocale::Galician, 50);
    addLanguage("Hrvatski", QLocale::Croatian, 50);
    addLanguage("Indonesian", QLocale::Indonesian, 7);
    addLanguage("Italiano", QLocale::Italian, 45);
    addLanguage("Magyar", QLocale::Hungarian, 26);
    ...
    addLanguage("हिन्दी", QLocale::Hindi, 27);
    addLanguage("தமிழ்", QLocale::Tamil, 34);
    addLanguage("తెలుగు", QLocale::Telugu, 92);
    addLanguage("Հայերեն", QLocale::Armenian, 14);
    addLanguage("汉语", QLocale::Chinese, 90);
    addLanguage("한국어", QLocale::Korean, 55);

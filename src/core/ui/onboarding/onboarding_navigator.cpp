...
void OnboardingNavigator::Implementation::initUiPage()
{
    ...
    addLanguage("Català", QLocale::Catalan, 85);
    addLanguage("Dansk", QLocale::Danish, 97);
    ...
    addLanguage("Polski", QLocale::Polish, 48);
    addLanguage("Português", static_cast<QLocale::Language>(QLocale::LastLanguage + 1), 13);
    addLanguage("Português Brasileiro", QLocale::Portuguese, 64);
    addLanguage("Română", QLocale::Romanian, 60);
    ...
    addLanguage("اَلْعَرَبِيَّةُ", QLocale::Arabic, 99);
    addLanguage("فارسی", QLocale::Persian, 66);
    addLanguage("עִבְרִית", QLocale::Hebrew, 77);
    addLanguage("हिन्दी", QLocale::Hindi, 34);
    addLanguage("தமிழ்", QLocale::Tamil, 44);

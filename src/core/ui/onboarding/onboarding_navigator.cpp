...
void OnboardingNavigator::Implementation::initUiPage()
{
    ...
    addLanguage("Беларуский", QLocale::Belarusian, 40);
    ...
    addLanguage("Nederlands", QLocale::Dutch, 90);
    addLanguage("Polski", QLocale::Polish, 92);
    addLanguage("Português", static_cast<QLocale::Language>(QLocale::LastLanguage + 1), 9);
    addLanguage("Português Brasileiro", QLocale::Portuguese, 94);
    addLanguage("Română", QLocale::Romanian, 39);
    addLanguage("Русский", QLocale::Russian, 100);
    addLanguage("Slovenski", QLocale::Slovenian, 100);
    addLanguage("Svenska", QLocale::Swedish, 28);
    addLanguage("Türkçe", QLocale::Turkish, 84);
    addLanguage("Українська", QLocale::Ukrainian, 91);
    addLanguage("اَلْعَرَبِيَّةُ", QLocale::Arabic, 75);
    addLanguage("فارسی", QLocale::Persian, 50);
    addLanguage("עִבְרִית", QLocale::Hebrew, 72);
    addLanguage("हिन्दी", QLocale::Hindi, 24);
    addLanguage("தமிழ்", QLocale::Tamil, 30);
    addLanguage("తెలుగు", QLocale::Telugu, 95);
    addLanguage("汉语", QLocale::Chinese, 80);
    addLanguage("한국어", QLocale::Korean, 47);

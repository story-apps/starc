...
void OnboardingNavigator::Implementation::initUiPage()
{
    ...
    addLanguage("Català", QLocale::Catalan, 84);
    addLanguage("Dansk", QLocale::Danish, 99);
    ...
    addLanguage("Nederlands", QLocale::Dutch, 99);
    addLanguage("Polski", QLocale::Polish, 39);
    ...
    addLanguage("اَلْعَرَبِيَّةُ", QLocale::Arabic, 100);

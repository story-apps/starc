...
void OnboardingNavigator::Implementation::initUiPage()
{
    ...
    addLanguage("Galego", QLocale::Galician, 72);
    addLanguage("Hrvatski", QLocale::Croatian, 72);
    addLanguage("Indonesian", QLocale::Indonesian, 10);
    addLanguage("Italiano", QLocale::Italian, 30);
    ...
    addLanguage("Română", QLocale::Romanian, 65);
    addLanguage("Русский", QLocale::Russian, 100);
    addLanguage("Slovenski", QLocale::Slovenian, 98);
    addLanguage("Tagalog", QLocale::Filipino, 20);
    addLanguage("Türkçe", QLocale::Turkish, 96);
    addLanguage("Українська", QLocale::Ukrainian, 100);
    addLanguage("اَلْعَرَبِيَّةُ", QLocale::Arabic, 18);
    addLanguage("فارسی", QLocale::Persian, 66);
    addLanguage("עִבְרִית", QLocale::Hebrew, 85);
    addLanguage("हिन्दी", QLocale::Hindi, 37);
    addLanguage("தமிழ்", QLocale::Tamil, 47);
    addLanguage("汉语", QLocale::Chinese, 6);
    addLanguage("한국어", QLocale::Korean, 79);

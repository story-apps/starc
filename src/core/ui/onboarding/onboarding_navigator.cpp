...
void OnboardingNavigator::Implementation::initUiPage()
{
    ...
    addLanguage("Беларуский", QLocale::Belarusian, 53);
    addLanguage("Català", QLocale::Catalan, 87);
    addLanguage("Dansk", QLocale::Danish, 96);
    addLanguage("Deutsch", QLocale::German, 71);
    auto englishItem = addLanguage("English", QLocale::English, 100);
    addLanguage("Español", QLocale::Spanish, 90);
    addLanguage("Esperanto", QLocale::Esperanto, 10);
    addLanguage("Français", QLocale::French, 69);
    addLanguage("Galego", QLocale::Galician, 74);
    addLanguage("Hrvatski", QLocale::Croatian, 74);
    addLanguage("Indonesian", QLocale::Indonesian, 10);
    addLanguage("Italiano", QLocale::Italian, 31);
    addLanguage("Magyar", QLocale::Hungarian, 37);
    addLanguage("Polski", QLocale::Polish, 43);
    addLanguage("Português", static_cast<QLocale::Language>(QLocale::LastLanguage + 1), 14);
    addLanguage("Português Brasileiro", QLocale::Portuguese, 72);
    addLanguage("Română", QLocale::Romanian, 67);
    ...
    addLanguage("Türkçe", QLocale::Turkish, 95);
    addLanguage("Українська", QLocale::Ukrainian, 100);
    addLanguage("اَلْعَرَبِيَّةُ", QLocale::Arabic, 18);
    addLanguage("فارسی", QLocale::Persian, 68);
    addLanguage("עִבְרִית", QLocale::Hebrew, 88);
    addLanguage("हिन्दी", QLocale::Hindi, 39);
    addLanguage("தமிழ்", QLocale::Tamil, 49);
    addLanguage("汉语", QLocale::Chinese, 6);
    addLanguage("한국어", QLocale::Korean, 82);

...
void OnboardingNavigator::Implementation::initUiPage()
{
    ...
    addLanguage("Беларуский", QLocale::Belarusian, 56);
    addLanguage("Català", QLocale::Catalan, 88);
    addLanguage("Dansk", QLocale::Danish, 90);
    addLanguage("Deutsch", QLocale::German, 75);
    auto englishItem = addLanguage("English", QLocale::English, 100);
    addLanguage("Español", QLocale::Spanish, 95);
    addLanguage("Esperanto", QLocale::Esperanto, 10);
    addLanguage("Français", QLocale::French, 72);
    addLanguage("Galego", QLocale::Galician, 78);
    addLanguage("Hrvatski", QLocale::Croatian, 78);
    addLanguage("Indonesian", QLocale::Indonesian, 11);
    addLanguage("Italiano", QLocale::Italian, 32);
    addLanguage("Magyar", QLocale::Hungarian, 39);
    addLanguage("Polski", QLocale::Polish, 46);
    addLanguage("Português", static_cast<QLocale::Language>(QLocale::LastLanguage + 1), 15);
    addLanguage("Português Brasileiro", QLocale::Portuguese, 75);
    addLanguage("Română", QLocale::Romanian, 70);
    addLanguage("Русский", QLocale::Russian, 100);
    addLanguage("Slovenski", QLocale::Slovenian, 100);
    addLanguage("Tagalog", QLocale::Filipino, 21);
    addLanguage("Türkçe", QLocale::Turkish, 100);
    addLanguage("Українська", QLocale::Ukrainian, 100);
    addLanguage("اَلْعَرَبِيَّةُ", QLocale::Arabic, 19);
    addLanguage("فارسی", QLocale::Persian, 71);
    addLanguage("עִבְרִית", QLocale::Hebrew, 93);
    addLanguage("हिन्दी", QLocale::Hindi, 40);
    addLanguage("தமிழ்", QLocale::Tamil, 51);
    addLanguage("汉语", QLocale::Chinese, 6);
    addLanguage("한국어", QLocale::Korean, 86);

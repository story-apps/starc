...
void OnboardingNavigator::Implementation::initUiPage()
{
    ...
    addLanguage("Dansk", QLocale::Danish, 95);
    addLanguage("Deutsch", QLocale::German, 100);
    auto englishItem = addLanguage("English", QLocale::English, 100);
    addLanguage("Español", QLocale::Spanish, 81);
    addLanguage("Esperanto", QLocale::Esperanto, 9);
    addLanguage("Français", QLocale::French, 60);
    addLanguage("Galego", QLocale::Galician, 64);
    addLanguage("Hrvatski", QLocale::Croatian, 64);
    ...
    addLanguage("Português Brasileiro", QLocale::Portuguese, 67);
    addLanguage("Română", QLocale::Romanian, 58);
    ...
    addLanguage("اَلْعَرَبِيَّةُ", QLocale::Arabic, 98);
    addLanguage("فارسی", QLocale::Persian, 65);
    addLanguage("עִבְרִית", QLocale::Hebrew, 75);
    addLanguage("हिन्दी", QLocale::Hindi, 33);
    addLanguage("தமிழ்", QLocale::Tamil, 42);
    addLanguage("తెలుగు", QLocale::Telugu, 100);
    addLanguage("汉语", QLocale::Chinese, 5);
    addLanguage("한국어", QLocale::Korean, 71);

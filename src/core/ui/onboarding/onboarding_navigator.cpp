...
void OnboardingNavigator::Implementation::initUiPage()
{
    ...
    addLanguage("Català", QLocale::Catalan, 69);
    addLanguage("Dansk", QLocale::Danish, 78);
    addLanguage("Deutsch", QLocale::German, 94);
    auto englishItem = addLanguage("English", QLocale::English, 100);
    addLanguage("Español", QLocale::Spanish, 73);
    addLanguage("Esperanto", QLocale::Esperanto, 7);
    addLanguage("Français", QLocale::French, 76);
    addLanguage("Galego", QLocale::Galician, 49);
    addLanguage("Hrvatski", QLocale::Croatian, 48);
    ...
    addLanguage("Română", QLocale::Romanian, 44);

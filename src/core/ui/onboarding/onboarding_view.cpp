...
void OnboardingView::Implementation::initLanguagePage()
{
    ...
    auto belarusianLanguage = initLanguageButton("Беларуский", QLocale::Belarusian, 60);
    auto catalanLanguage = initLanguageButton("Català", QLocale::Catalan, 81);
    auto chineseLanguage = initLanguageButton("汉语", QLocale::Chinese, 7);
    auto croatianLanguage = initLanguageButton("Hrvatski", QLocale::Croatian, 75);
    auto danishLanguage = initLanguageButton("Dansk", QLocale::Danish, 97);
    ...
    auto frenchLanguage = initLanguageButton("Français", QLocale::French, 77);
    auto galicianLanguage = initLanguageButton("Galego", QLocale::Galician, 83);
    auto germanLanguage = initLanguageButton("Deutsch", QLocale::German, 80);
    auto hebrewLanguage = initLanguageButton("עִבְרִית", QLocale::Hebrew, 97);
    auto hindiLanguage = initLanguageButton("हिन्दी", QLocale::Hindi, 44);
    auto hungarianLanguage = initLanguageButton("Magyar", QLocale::Hungarian, 42);
    ...
    auto koreanLanguage = initLanguageButton("한국어", QLocale::Korean, 92);
    auto persianLanguage = initLanguageButton("فارسی", QLocale::Persian, 76);
    auto polishLanguage = initLanguageButton("Polski", QLocale::Polish, 38);
    ...
    auto romanianLanguage = initLanguageButton("Română", QLocale::Romanian, 75);
    ...
    auto spanishLanguage = initLanguageButton("Español", QLocale::Spanish, 96);

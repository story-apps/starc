...
void OnboardingView::Implementation::initLanguagePage()
{
    ...
    auto arabicLanguage = initLanguageButton("اَلْعَرَبِيَّةُ", QLocale::Arabic, 20);
    auto azerbaijaniLanguage = initLanguageButton("Azərbaycan", QLocale::Azerbaijani, 100);
    auto belarusianLanguage = initLanguageButton("Беларуский", QLocale::Belarusian, 58);
    auto catalanLanguage = initLanguageButton("Català", QLocale::Catalan, 90);
    auto chineseLanguage = initLanguageButton("汉语", QLocale::Chinese, 7);
    auto croatianLanguage = initLanguageButton("Hrvatski", QLocale::Croatian, 73);
    auto danishLanguage = initLanguageButton("Dansk", QLocale::Danish, 95);
    ...
    auto frenchLanguage = initLanguageButton("Français", QLocale::French, 76);
    auto galicianLanguage = initLanguageButton("Galego", QLocale::Galician, 82);
    auto germanLanguage = initLanguageButton("Deutsch", QLocale::German, 79);
    auto hebrewLanguage = initLanguageButton("עִבְרִית", QLocale::Hebrew, 96);
    auto hindiLanguage = initLanguageButton("हिन्दी", QLocale::Hindi, 43);
    auto hungarianLanguage = initLanguageButton("Magyar", QLocale::Hungarian, 41);
    auto indonesianLanguage = initLanguageButton("Indonesian", QLocale::Indonesian, 12);
    auto italianLanguage = initLanguageButton("Italiano", QLocale::Italian, 35);
    auto koreanLanguage = initLanguageButton("한국어", QLocale::Korean, 91);
    auto persianLanguage = initLanguageButton("فارسی", QLocale::Persian, 75);
    auto polishLanguage = initLanguageButton("Polski", QLocale::Polish, 49);
    auto portugueseLanguage = initLanguageButton(
        "Português", static_cast<QLocale::Language>(QLocale::LastLanguage + 1), 15);
    auto portugueseBrazilLanguage
        = initLanguageButton("Português Brasileiro", QLocale::Portuguese, 80);
    auto romanianLanguage = initLanguageButton("Română", QLocale::Romanian, 73);
    ...
    auto spanishLanguage = initLanguageButton("Español", QLocale::Spanish, 100);
    auto tagalogLanguage = initLanguageButton("Tagalog", QLocale::Filipino, 22);
    auto tamilLanguage = initLanguageButton("தமிழ்", QLocale::Tamil, 54);

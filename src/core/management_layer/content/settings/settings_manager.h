...
public:
    ...
    /**
     * @brief Проверить целостность словарей проверки орфографии и при необходимости загрузить их
     */
    void validateSpellCheckerDictionaries();

    /**
     * @brief Перечитать настройки
     * @note Это необходимо делать ровно один раз - после завершения онбординга, чтобы подхватить те
     *       опции, которые пользователь задал в нём
     */
    void reloadSettings();

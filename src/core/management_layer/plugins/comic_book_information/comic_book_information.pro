...
TARGET = comicbookinformationplugin
...
HEADERS += \
    comic_book_information_manager.h \
    comic_book_information_view.h

SOURCES += \
    comic_book_information_manager.cpp \
    comic_book_information_view.cpp

...
class LocationInformationStructureView : public AbstractNavigator, public IDocumentView
{
    Q_OBJECT

public:
    explicit LocationInformationStructureView(QWidget* _parent = nullptr);
    ~LocationInformationStructureView() override;

 ...
 */
class MANAGER_PLUGIN_EXPORT LocationInformationStructureManager : public QObject,
...
public:
    explicit LocationInformationStructureManager(QObject* _parent = nullptr);
    ~LocationInformationStructureManager() override;

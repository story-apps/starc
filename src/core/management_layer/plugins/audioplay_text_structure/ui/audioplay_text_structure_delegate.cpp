...
class AudioplayTextStructureDelegate::Implementation
{
public:
    /**
...
void AudioplayTextStructureDelegate::Implementation::paintFolder(
...
void AudioplayTextStructureDelegate::Implementation::paintText(QPainter* _painter,
                                                               const QStyleOptionViewItem& _option,
                                                               const QModelIndex& _index) const
{
    using namespace BusinessLayer;
...
QSize AudioplayTextStructureDelegate::Implementation::sceneSizeHint(
    const QStyleOptionViewItem& _option, const QModelIndex& _index) const
{
    using namespace BusinessLayer;
...
AudioplayTextStructureDelegate::AudioplayTextStructureDelegate(QObject* _parent)
    : QStyledItemDelegate(_parent)
    , d(new Implementation)
{
}

AudioplayTextStructureDelegate::~AudioplayTextStructureDelegate() = default;

void AudioplayTextStructureDelegate::showSceneNumber(bool _show)
{
    d->showSceneNumber = _show;
}

void AudioplayTextStructureDelegate::setTextLinesSize(int _size)
{
    d->textLines = _size;
}

void AudioplayTextStructureDelegate::paint(QPainter* _painter, const QStyleOptionViewItem& _option,
                                           const QModelIndex& _index) const
{
    //
...
QSize AudioplayTextStructureDelegate::sizeHint(const QStyleOptionViewItem& _option,
                                               const QModelIndex& _index) const
{

 ...
 */
class AudioplayTextStructureModel : public QSortFilterProxyModel
{
    Q_OBJECT

public:
    explicit AudioplayTextStructureModel(QObject* _parent = nullptr);
    ~AudioplayTextStructureModel() override;

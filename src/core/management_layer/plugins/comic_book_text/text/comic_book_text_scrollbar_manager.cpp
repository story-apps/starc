#include "comic_book_text_scrollbar_manager.h"
...
class ComicBookTextScrollBarManager::Implementation
{
public:
    ...
    ComicBookTextTimeline* timeline = nullptr;
};

ComicBookTextScrollBarManager::Implementation::Implementation(QWidget* _parent)
    : scrollbar(new QScrollBar(_parent))
    , timeline(new ComicBookTextTimeline(_parent))
{
}

void ComicBookTextScrollBarManager::Implementation::updateTimelineGeometry()
{
...
ComicBookTextScrollBarManager::ComicBookTextScrollBarManager(QAbstractScrollArea* _parent)
    : QObject(_parent)
...
ComicBookTextScrollBarManager::~ComicBookTextScrollBarManager() = default;

void ComicBookTextScrollBarManager::initScrollBarsSyncing()
{
    ...
    //    connect(d->timeline, &ComicBookTextTimeline::valueChanged, this,
    ...
    //            });
    //    connect(d->timeline, &ComicBookTextTimeline::updateValueRequested, this,
    //    updateTimelineValue);
}

void ComicBookTextScrollBarManager::setModel(BusinessLayer::ComicBookTextModel* _model)
{
    //    if (d->model == _model) {
    //        return;
    //    }
...
bool ComicBookTextScrollBarManager::eventFilter(QObject* _watched, QEvent* _event)
{
...
class ComicBookTextTimeline::Implementation
{
public:
...
ComicBookTextTimeline::ComicBookTextTimeline(QWidget* _parent)
    : Widget(_parent)
    , d(new Implementation)
{
}

ComicBookTextTimeline::~ComicBookTextTimeline() = default;

void ComicBookTextTimeline::setScrollable(bool _scrollable)
{
...
void ComicBookTextTimeline::setMaximum(std::chrono::milliseconds _maximum)
{
...
void ComicBookTextTimeline::setValue(std::chrono::milliseconds _value)
{
...
void ComicBookTextTimeline::setColors(const std::map<std::chrono::milliseconds, QColor>& _colors)
{
    if (d->colors == _colors) {
        return;
    }
...
QSize ComicBookTextTimeline::sizeHint() const
{
...
void ComicBookTextTimeline::paintEvent(QPaintEvent* _event)
{
    Q_UNUSED(_event)
...
void ComicBookTextTimeline::mousePressEvent(QMouseEvent* _event)
{
    if (!d->scrollable) {
        return;
    }
...
void ComicBookTextTimeline::mouseMoveEvent(QMouseEvent* _event)
{
    if (!d->scrollable) {
        return;
    }
...
void ComicBookTextTimeline::mouseReleaseEvent(QMouseEvent* _event)
{
    Q_UNUSED(_event);
...
void ComicBookTextTimeline::wheelEvent(QWheelEvent* _event)
{
    if (!d->scrollable) {
        return;
    }
...
void ComicBookTextTimeline::designSystemChangeEvent(DesignSystemChangeEvent* _event)
{
...
void ComicBookTextTimeline::updateValue(const QPoint& _mousePosition)
{

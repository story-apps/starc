    ...
    , d(new Implementation(this))
{
    ...
    connect(document(), &QTextDocument::contentsChange, this,
            &ComicBookTextEdit::updateCollaboratorsCursors);
    connect(this, &ComicBookTextEdit::completed, this,
...
void ComicBookTextEdit::initWithModel(BusinessLayer::ComicBookTextModel* _model)
{
    ...
    if (d->model && d->model->informationModel()) {
        ...
        //
        connect(d->model, &BusinessLayer::ComicBookTextModel::changesAboutToBeApplied, this,
                [this] {
        ...
        connect(d->model, &BusinessLayer::ComicBookTextModel::changesApplied, this,

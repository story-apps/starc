...
class ComicBookTextEditToolbar::Implementation
{
public:
...
ComicBookTextEditToolbar::ComicBookTextEditToolbar(QWidget* _parent)
    ...
    , d(new Implementation(this))
{
    ...
    connect(d->undoAction, &QAction::triggered, this, &ComicBookTextEditToolbar::undoPressed);

    d->redoAction->setIconText(u8"\U000f044e");
    addAction(d->redoAction);
    connect(d->redoAction, &QAction::triggered, this, &ComicBookTextEditToolbar::redoPressed);
    ...
    connect(d->searchAction, &QAction::triggered, this, &ComicBookTextEditToolbar::searchPressed);
    ...
    connect(d->aiAssistantAction, &QAction::toggled, this,
            &ComicBookTextEditToolbar::updateTranslations);
    connect(d->aiAssistantAction, &QAction::toggled, this,
            &ComicBookTextEditToolbar::aiAssistantEnabledChanged);
...
void ComicBookTextEditToolbar::setCurrentParagraphType(const QModelIndex& _index)
{
    //
...
bool ComicBookTextEditToolbar::isFastFormatPanelVisible() const
{
    return d->fastFormatAction->isChecked();
}

void ComicBookTextEditToolbar::setFastFormatPanelVisible(bool _visible)
{
    d->fastFormatAction->setChecked(_visible);
}

QString ComicBookTextEditToolbar::searchIcon() const
{
    return d->searchAction->iconText();
}

QPointF ComicBookTextEditToolbar::searchIconPosition() const
{
...
bool ComicBookTextEditToolbar::isCommentsModeEnabled() const
{
...
bool ComicBookTextEditToolbar::isAiAssistantEnabled() const
{
    return d->aiAssistantAction->isChecked();
}

void ComicBookTextEditToolbar::setAiAssistantEnabled(bool _enabled)
{
...
void ComicBookTextEditToolbar::setOptions(const QVector<QAction*>& _options)
{
    d->options = _options;
}

...
class ComicBookTextSearchToolbar::Implementation
{
public:
...
ComicBookTextSearchToolbar::Implementation::Implementation(QWidget* _parent)
...
ComicBookTextSearchToolbar::ComicBookTextSearchToolbar(QWidget* _parent)
    ...
    , d(new Implementation(this))
{
    ...
    connect(d->goToPreviousAction, &QAction::triggered, this,
            &ComicBookTextSearchToolbar::findPreviousRequested);
    ...
    connect(d->goToNextAction, &QAction::triggered, this,
            &ComicBookTextSearchToolbar::findNextRequested);
    ...
    connect(d->matchCaseAction, &QAction::toggled, this,
            &ComicBookTextSearchToolbar::findTextRequested);
    //
    ...
    connect(d->replace, &Button::clicked, this, &ComicBookTextSearchToolbar::replaceOnePressed);
    addAction(d->replaceAllAction);
    connect(d->replaceAll, &Button::clicked, this, &ComicBookTextSearchToolbar::replaceAllPressed);
...
QString ComicBookTextSearchToolbar::searchText() const
{
    return d->lastSearchText;
}

bool ComicBookTextSearchToolbar::isCaseSensitive() const
{
...
bool ComicBookTextSearchToolbar::eventFilter(QObject* _watched, QEvent* _event)
{
    switch (_event->type()) {
    case QEvent::Resize: {
        if (_watched == parent()) {
...
void ComicBookTextSearchToolbar::designSystemChangeEvent(DesignSystemChangeEvent* _event)
{

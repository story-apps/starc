    ...
    TextParagraphType _forBlockType)
{
    ...
    const QKeySequence keySequence(ShortcutsHelper::comicBookShortcut(_forBlockType));
...
void ComicBookTextEditShortcutsManager::setShortcutsContext(QWidget* _context)
{
    ...
    d->createOrUpdateShortcut(TextParagraphType::PageHeading);
    d->createOrUpdateShortcut(TextParagraphType::PanelHeading);
...
void ComicBookTextEditShortcutsManager::setEnabled(bool _enabled)
{

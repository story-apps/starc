...
TARGET = comicbookparametersplugin
...
HEADERS += \
    comic_book_parameters_manager.h \
    comic_book_parameters_view.h

SOURCES += \
    comic_book_parameters_manager.cpp \
    comic_book_parameters_view.cpp

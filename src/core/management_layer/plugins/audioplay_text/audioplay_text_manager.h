 ...
 */
class MANAGER_PLUGIN_EXPORT AudioplayTextManager : public QObject, public IDocumentManager
{
    Q_OBJECT
...
public:
    explicit AudioplayTextManager(QObject* _parent = nullptr);
    ~AudioplayTextManager() override;

...
class AudioplayTextSearchToolbar::Implementation
{
public:
     ...
     */
    void showPopup(AudioplayTextSearchToolbar* _parent);
...
AudioplayTextSearchToolbar::Implementation::Implementation(QWidget* _parent)
...
void AudioplayTextSearchToolbar::Implementation::showPopup(AudioplayTextSearchToolbar* _parent)
{
...
AudioplayTextSearchToolbar::AudioplayTextSearchToolbar(QWidget* _parent)
    ...
    , d(new Implementation(this))
{
    ...
    connect(d->goToPreviousAction, &QAction::triggered, this,
            &AudioplayTextSearchToolbar::findPreviousRequested);
    ...
    connect(d->goToNextAction, &QAction::triggered, this,
            &AudioplayTextSearchToolbar::findNextRequested);
    ...
    connect(d->matchCaseAction, &QAction::toggled, this,
            &AudioplayTextSearchToolbar::findTextRequested);
    //
...
QString AudioplayTextSearchToolbar::searchText() const
{
    return d->lastSearchText;
}

bool AudioplayTextSearchToolbar::isCaseSensitive() const
{
    return d->matchCaseAction->isChecked();
}

int AudioplayTextSearchToolbar::searchInType() const
{
    return d->popup->currentIndex().row();
}

QString AudioplayTextSearchToolbar::replaceText() const
{
    return d->replaceText->text();
}

bool AudioplayTextSearchToolbar::eventFilter(QObject* _watched, QEvent* _event)
{
    switch (_event->type()) {
    case QEvent::Resize: {
        if (_watched == parent()) {
...
void AudioplayTextSearchToolbar::processTextColorChange()
{
...
void AudioplayTextSearchToolbar::updateTranslations()
{
...
void AudioplayTextSearchToolbar::designSystemChangeEvent(DesignSystemChangeEvent* _event)
{

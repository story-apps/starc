#include "audioplay_text_fast_format_widget.h"
...
class AudioplayTextFastFormatWidget::Implementation
{
public:
...
AudioplayTextFastFormatWidget::Implementation::Implementation(QWidget* _parent)
{
    //
...
void AudioplayTextFastFormatWidget::Implementation::updateButtons()
{
...
AudioplayTextFastFormatWidget::AudioplayTextFastFormatWidget(QWidget* _parent)
    : Widget(_parent)
...
AudioplayTextFastFormatWidget::~AudioplayTextFastFormatWidget() = default;

void AudioplayTextFastFormatWidget::setParagraphTypesModel(QAbstractItemModel* _model)
{
    if (d->model == _model) {
        return;
    }
...
void AudioplayTextFastFormatWidget::setCurrentParagraphType(const QModelIndex& _index)
{
    for (auto button : d->buttons) {
...
void AudioplayTextFastFormatWidget::designSystemChangeEvent(DesignSystemChangeEvent* _event)
{

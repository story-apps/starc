...
class StageplayDictionariesModel;
class TextCursor;
 ...
 */
class StageplayTextEdit : public ScriptTextEdit
{
    Q_OBJECT

public:
    explicit StageplayTextEdit(QWidget* _parent = nullptr);
    ~StageplayTextEdit() override;
     ...
     */
    void initWithModel(BusinessLayer::StageplayTextModel* _model);

 ...
 */
class StageplayTextView : public Widget, public IDocumentView
{
    Q_OBJECT

public:
    explicit StageplayTextView(QWidget* _parent = nullptr);
    ~StageplayTextView() override;
     ...
     */
    void setModel(BusinessLayer::StageplayTextModel* _model);

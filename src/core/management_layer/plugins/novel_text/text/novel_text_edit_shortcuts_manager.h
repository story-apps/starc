 ...
 */
class NovelTextEditShortcutsManager : public QObject
{
    Q_OBJECT

public:
    NovelTextEditShortcutsManager() = delete;
    explicit NovelTextEditShortcutsManager(NovelTextEdit* _parent = nullptr);
    ~NovelTextEditShortcutsManager() override;

...
class NovelTextSearchToolbar::Implementation
{
public:
     ...
     */
    void showPopup(NovelTextSearchToolbar* _parent);
...
NovelTextSearchToolbar::Implementation::Implementation(QWidget* _parent)
...
void NovelTextSearchToolbar::Implementation::showPopup(NovelTextSearchToolbar* _parent)
{
...
NovelTextSearchToolbar::NovelTextSearchToolbar(QWidget* _parent)
    ...
    , d(new Implementation(this))
{
    ...
    connect(d->goToPreviousAction, &QAction::triggered, this,
            &NovelTextSearchToolbar::findPreviousRequested);
    ...
    connect(d->goToNextAction, &QAction::triggered, this,
            &NovelTextSearchToolbar::findNextRequested);
    ...
    connect(d->matchCaseAction, &QAction::toggled, this,
            &NovelTextSearchToolbar::findTextRequested);
    //
    ...
    connect(d->replace, &Button::clicked, this, &NovelTextSearchToolbar::replaceOnePressed);
    addAction(d->replaceAllAction);
    connect(d->replaceAll, &Button::clicked, this, &NovelTextSearchToolbar::replaceAllPressed);
}

NovelTextSearchToolbar::~NovelTextSearchToolbar() = default;

void NovelTextSearchToolbar::setReadOnly(bool _readOnly)
{
...
void NovelTextSearchToolbar::refocus()
{
    d->searchText->setFocus();
}

QString NovelTextSearchToolbar::searchText() const
{
    return d->lastSearchText;
}

bool NovelTextSearchToolbar::isCaseSensitive() const
{
    return d->matchCaseAction->isChecked();
}

int NovelTextSearchToolbar::searchInType() const
{
    return d->popup->currentIndex().row();
}

QString NovelTextSearchToolbar::replaceText() const
{
...
bool NovelTextSearchToolbar::canAnimateHoverOut() const
{
    return !d->popup->isVisible();
}

void NovelTextSearchToolbar::processBackgroundColorChange()
{
...
void NovelTextSearchToolbar::processTextColorChange()
{
...
void NovelTextSearchToolbar::updateTranslations()
{
    ...
    if (auto model = qobject_cast<QStringListModel*>(d->popup->contentModel())) {
        model->setStringList({ tr("In the whole text"), tr("In scene heading"), tr("In text") });
...
void NovelTextSearchToolbar::designSystemChangeEvent(DesignSystemChangeEvent* _event)
{

#include "novel_text_fast_format_widget.h"
...
class NovelTextFastFormatWidget::Implementation
{
public:
...
NovelTextFastFormatWidget::Implementation::Implementation(QWidget* _parent)
{
    //
...
void NovelTextFastFormatWidget::Implementation::updateButtons()
{
...
NovelTextFastFormatWidget::NovelTextFastFormatWidget(QWidget* _parent)
    : Widget(_parent)
...
NovelTextFastFormatWidget::~NovelTextFastFormatWidget() = default;

void NovelTextFastFormatWidget::setParagraphTypesModel(QAbstractItemModel* _model)
{
    if (d->model == _model) {
        return;
    }
...
void NovelTextFastFormatWidget::setCurrentParagraphType(const QModelIndex& _index)
{
    for (auto button : std::as_const(d->buttons)) {
...
void NovelTextFastFormatWidget::designSystemChangeEvent(DesignSystemChangeEvent* _event)
{

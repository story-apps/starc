 ...
 */
class MANAGER_PLUGIN_EXPORT NovelTextManager : public QObject, public IDocumentManager
{
    Q_OBJECT
...
public:
    explicit NovelTextManager(QObject* _parent = nullptr);
    ~NovelTextManager() override;

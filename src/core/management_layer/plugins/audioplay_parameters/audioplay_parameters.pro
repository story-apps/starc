...
TARGET = audioplayparametersplugin
...
HEADERS += \
    audioplay_parameters_manager.h \
    audioplay_parameters_view.h

SOURCES += \
    audioplay_parameters_manager.cpp \
    audioplay_parameters_view.cpp

...
TARGET = screenplayseriesparametersplugin
...
HEADERS += \
    screenplay_series_parameters_manager.h \
    screenplay_series_parameters_view.h

SOURCES += \
    screenplay_series_parameters_manager.cpp \
    screenplay_series_parameters_view.cpp

 ...
 */
class MANAGER_PLUGIN_EXPORT ScreenplayStatisticsStructureManager : public QObject,
...
public:
    explicit ScreenplayStatisticsStructureManager(QObject* _parent = nullptr);
    ~ScreenplayStatisticsStructureManager() override;

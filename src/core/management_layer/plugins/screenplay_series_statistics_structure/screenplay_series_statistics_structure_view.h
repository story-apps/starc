...
class ScreenplayStatisticsStructureView : public AbstractNavigator, public IDocumentView
{
    Q_OBJECT

public:
    explicit ScreenplayStatisticsStructureView(QWidget* _parent = nullptr);
    ~ScreenplayStatisticsStructureView() override;

...
/**
 * @brief Менеджер труктуры текстового документа
 */
class MANAGER_PLUGIN_EXPORT SimpleTextStructureManager : public QObject, public IDocumentManager
{
    Q_OBJECT
...
public:
    explicit SimpleTextStructureManager(QObject* _parent = nullptr);
    ~SimpleTextStructureManager() override;

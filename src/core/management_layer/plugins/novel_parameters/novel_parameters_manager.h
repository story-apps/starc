 ...
 */
class MANAGER_PLUGIN_EXPORT NovelParametersManager : public QObject, public IDocumentManager
{
    Q_OBJECT
...
public:
    explicit NovelParametersManager(QObject* _parent = nullptr);
    ~NovelParametersManager() override;

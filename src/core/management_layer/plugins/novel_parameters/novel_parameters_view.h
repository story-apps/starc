 ...
 */
class NovelParametersView : public Widget, public IDocumentView
{
    Q_OBJECT

public:
    explicit NovelParametersView(QWidget* _parent = nullptr);
    ~NovelParametersView() override;
    ...
    void setNovelTemplate(const QString& _templateId);
    Q_SIGNAL void novelTemplateChanged(const QString& _templateId);

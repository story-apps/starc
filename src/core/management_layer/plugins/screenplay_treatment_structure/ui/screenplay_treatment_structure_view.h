...
class ScreenplayTreatmentStructureView : public AbstractNavigator, public IDocumentView
{
    Q_OBJECT

public:
    explicit ScreenplayTreatmentStructureView(QWidget* _parent = nullptr);
    ~ScreenplayTreatmentStructureView() override;

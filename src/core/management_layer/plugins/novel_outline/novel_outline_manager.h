 ...
 */
class MANAGER_PLUGIN_EXPORT NovelOutlineManager : public QObject, public IDocumentManager
{
    Q_OBJECT
...
public:
    explicit NovelOutlineManager(QObject* _parent = nullptr);
    ~NovelOutlineManager() override;

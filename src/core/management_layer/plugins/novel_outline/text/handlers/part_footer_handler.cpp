...
PartFooterHandler::PartFooterHandler(NovelOutlineEdit* _editor)
    : StandardKeyHandler(_editor)
{
}

void PartFooterHandler::handleEnter(QKeyEvent*)
{
    //
    ...
    if (editor()->isCompleterVisible()) {
        ...
        if (cursor.hasSelection()) {
            ...
            if (cursorBackwardText.isEmpty() && cursorForwardText.isEmpty()) {
                ...
                // Вставить блок
                //
                editor()->addParagraph(TextParagraphType::PartHeading);
...
void PartFooterHandler::handleTab(QKeyEvent*)
{
    //
    // Получим необходимые значения
    //

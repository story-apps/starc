#include "novel_outline_fast_format_widget.h"
...
class NovelOutlineFastFormatWidget::Implementation
{
public:
...
NovelOutlineFastFormatWidget::Implementation::Implementation(QWidget* _parent)
{
    //
...
void NovelOutlineFastFormatWidget::Implementation::updateButtons()
{
...
NovelOutlineFastFormatWidget::NovelOutlineFastFormatWidget(QWidget* _parent)
    : Widget(_parent)
...
NovelOutlineFastFormatWidget::~NovelOutlineFastFormatWidget() = default;

void NovelOutlineFastFormatWidget::setParagraphTypesModel(QAbstractItemModel* _model)
{
    if (d->model == _model) {
        return;
    }
...
void NovelOutlineFastFormatWidget::setCurrentParagraphType(const QModelIndex& _index)
{
    for (auto button : std::as_const(d->buttons)) {
...
void NovelOutlineFastFormatWidget::designSystemChangeEvent(DesignSystemChangeEvent* _event)
{

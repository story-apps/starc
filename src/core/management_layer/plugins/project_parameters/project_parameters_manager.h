...
/**
 * @brief Менеджер параметров проекта
 */
class MANAGER_PLUGIN_EXPORT ProjectParametersManager : public QObject, public IDocumentManager
{
    Q_OBJECT
...
public:
    explicit ProjectParametersManager(QObject* _parent = nullptr);
    ~ProjectParametersManager() override;

...
TARGET = stageplayinformationplugin
...
HEADERS += \
    stageplay_information_manager.h \
    stageplay_information_view.h

SOURCES += \
    stageplay_information_manager.cpp \
    stageplay_information_view.cpp

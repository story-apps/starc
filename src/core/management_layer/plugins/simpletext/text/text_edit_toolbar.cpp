...
class TextEditToolbar::Implementation
{
public:
     ...
     */
    void showPopup(TextEditToolbar* _parent);
...
TextEditToolbar::Implementation::Implementation(QWidget* _parent)
...
void TextEditToolbar::Implementation::showPopup(TextEditToolbar* _parent)
{
...
void TextEditToolbar::Implementation::hidePopup()
{
    isPopupShown = false;
...
TextEditToolbar::TextEditToolbar(QWidget* _parent)
    : FloatingToolBar(_parent),
      d(new Implementation(this))
{
    d->undoAction->setIconText(u8"\U000f054c");
    addAction(d->undoAction);
    connect(d->undoAction, &QAction::triggered, this, &TextEditToolbar::undoPressed);

    d->redoAction->setIconText(u8"\U000f044e");
    addAction(d->redoAction);
    connect(d->redoAction, &QAction::triggered, this, &TextEditToolbar::redoPressed);
    ...
    connect(d->fastFormatAction, &QAction::toggled, this, &TextEditToolbar::updateTranslations);
    connect(d->fastFormatAction, &QAction::toggled, this, &TextEditToolbar::fastFormatPanelVisibleChanged);
    ...
    connect(d->searchAction, &QAction::triggered, this, &TextEditToolbar::searchPressed);
    ...
    connect(d->commentsAction, &QAction::toggled, this, &TextEditToolbar::updateTranslations);
    connect(d->commentsAction, &QAction::toggled, this, &TextEditToolbar::commentsModeEnabledChanged);
...
TextEditToolbar::~TextEditToolbar() = default;

void TextEditToolbar::setParagraphTypesModel(QAbstractItemModel* _model)
{
...
void TextEditToolbar::setCurrentParagraphType(const QModelIndex& _index)
{
    //
...
bool TextEditToolbar::isFastFormatPanelVisible() const
{
    return d->fastFormatAction->isChecked();
}

void TextEditToolbar::setFastFormatPanelVisible(bool _visible)
{
    d->fastFormatAction->setChecked(_visible);
}

QString TextEditToolbar::searchIcon() const
{
    return d->searchAction->iconText();
}

QPointF TextEditToolbar::searchIconPosition() const
{
...
bool TextEditToolbar::isCommentsModeEnabled() const
{
    return d->commentsAction->isChecked();
}

void TextEditToolbar::setCommentsModeEnabled(bool _enabled)
{
    d->commentsAction->setChecked(_enabled);
}

void TextEditToolbar::focusOutEvent(QFocusEvent* _event)
{
...
void TextEditToolbar::updateTranslations()
{
...
void TextEditToolbar::designSystemChangeEvent(DesignSystemChangeEvent* _event)
{

...
void TextEdit::initWithModel(BusinessLayer::TextModel* _model)
{
    d->model = _model;
...
void TextEdit::setCurrentParagraphType(BusinessLayer::TextParagraphType _type)
{
...
BusinessLayer::TextParagraphType TextEdit::currentParagraphType() const
{
    return TextBlockStyle::forBlock(textCursor().block());
}

void TextEdit::setTextCursorReimpl(const QTextCursor& _cursor)
{
    //
...
QModelIndex TextEdit::currentModelIndex() const
{
    if (d->model == nullptr) {
        return {};
    }
...
void TextEdit::setCurrentModelIndex(const QModelIndex& _index)
{
...
int TextEdit::positionForModelIndex(const QModelIndex& _index)
{
    return d->document.itemStartPosition(_index);
}

void TextEdit::addReviewMark(const QColor& _textColor, const QColor& _backgroundColor, const QString& _comment)
{
...
void TextEdit::keyPressEvent(QKeyEvent* _event)
{
    if (isReadOnly()) {
        return;
    }
...
bool TextEdit::keyPressEventReimpl(QKeyEvent* _event)
{
...
bool TextEdit::updateEnteredText(const QString& _eventText)
{
...
void TextEdit::paintEvent(QPaintEvent* _event)
{
...
bool TextEdit::canInsertFromMimeData(const QMimeData* _source) const
{
...
void TextEdit::insertFromMimeData(const QMimeData* _source)
{
    if (isReadOnly()) {
        return;
    }

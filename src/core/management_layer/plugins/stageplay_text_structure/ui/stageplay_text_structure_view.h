 ...
 */
class StageplayTextStructureView : public AbstractNavigator, public IDocumentView
{
    Q_OBJECT

public:
    explicit StageplayTextStructureView(QWidget* _parent = nullptr);
    ~StageplayTextStructureView() override;
    ...
    void setCurrentModelIndex(const QModelIndex& _sourceIndex) override;
    /** @} */

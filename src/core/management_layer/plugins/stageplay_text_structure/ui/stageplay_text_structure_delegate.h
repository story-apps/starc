 ...
 */
class StageplayTextStructureDelegate : public QStyledItemDelegate
{
public:
    explicit StageplayTextStructureDelegate(QObject* _parent = nullptr);
    ~StageplayTextStructureDelegate() override;

 ...
 */
class MANAGER_PLUGIN_EXPORT ScreenplayBreakdownStructureManager : public QObject,
...
public:
    explicit ScreenplayBreakdownStructureManager(QObject* _parent = nullptr);
    ~ScreenplayBreakdownStructureManager() override;

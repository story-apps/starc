...
class ScreenplayBreakdownStructureSceneDelegate::Implementation
{
public:
    /**
...
void ScreenplayBreakdownStructureSceneDelegate::Implementation::paintItemColor(
...
QRectF ScreenplayBreakdownStructureSceneDelegate::Implementation::paintItemDuration(
...
void ScreenplayBreakdownStructureSceneDelegate::Implementation::paintFolder(
...
void ScreenplayBreakdownStructureSceneDelegate::Implementation::paintScene(
    QPainter* _painter, const QStyleOptionViewItem& _option, const QModelIndex& _index) const
{
    using namespace BusinessLayer;
...
QSize ScreenplayBreakdownStructureSceneDelegate::Implementation::folderSizeHint(
...
QSize ScreenplayBreakdownStructureSceneDelegate::Implementation::sceneSizeHint(
...
ScreenplayBreakdownStructureSceneDelegate::ScreenplayBreakdownStructureSceneDelegate(
    QObject* _parent)
...
ScreenplayBreakdownStructureSceneDelegate::~ScreenplayBreakdownStructureSceneDelegate() = default;

void ScreenplayBreakdownStructureSceneDelegate::showSceneNumber(bool _show)
{
    d->showSceneNumber = _show;
}

void ScreenplayBreakdownStructureSceneDelegate::setTextLinesSize(int _size)
{
    d->textLines = _size;
}

void ScreenplayBreakdownStructureSceneDelegate::paint(QPainter* _painter,
...
QSize ScreenplayBreakdownStructureSceneDelegate::sizeHint(const QStyleOptionViewItem& _option,
                                                          const QModelIndex& _index) const
{

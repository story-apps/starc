      ...
      d(new Implementation(this))
{
    ...
    connect(d->toolbar, &SimpleTextEditToolbar::paragraphTypeChanged, this, [this] (const QModelIndex& _index) {
    ...
    //
    connect(d->searchManager, &BusinessLayer::SimpleTextSearchManager::hideToolbarRequested, this, [this] {

 ...
 */
class MANAGER_PLUGIN_EXPORT RecycleBinManager : public QObject, public IDocumentManager
{
    Q_OBJECT
...
public:
    explicit RecycleBinManager(QObject* _parent = nullptr);
    ~RecycleBinManager() override;

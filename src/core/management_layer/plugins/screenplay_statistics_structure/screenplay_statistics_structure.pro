...
TARGET = screenplaystatisticsstructureplugin
...
HEADERS += \
    screenplay_statistics_structure_manager.h \
    screenplay_statistics_structure_view.h

SOURCES += \
    screenplay_statistics_structure_manager.cpp \
    screenplay_statistics_structure_view.cpp

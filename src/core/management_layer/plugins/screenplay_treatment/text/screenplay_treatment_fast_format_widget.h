 ...
 */
class ScreenplayTreatmentFastFormatWidget : public Widget
{
    Q_OBJECT

public:
    explicit ScreenplayTreatmentFastFormatWidget(QWidget* _parent = nullptr);
    ~ScreenplayTreatmentFastFormatWidget() override;

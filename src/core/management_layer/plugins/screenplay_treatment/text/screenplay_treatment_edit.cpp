...
void ScreenplayTreatmentEdit::Implementation::updateReviewMark(QKeyEvent* _event, int _from,
                                                               int _to)
{
    ...
    , d(new Implementation(this))
{
    ...
    connect(document(), &QTextDocument::contentsChange, this,
            &ScreenplayTreatmentEdit::updateCollaboratorsCursors);
    connect(this, &ScreenplayTreatmentEdit::completed, this,
...
void ScreenplayTreatmentEdit::initWithModel(BusinessLayer::ScreenplayTextModel* _model)
{
    ...
    if (d->model && d->model->informationModel()) {
        ...
        //
        connect(d->model, &BusinessLayer::ScreenplayTextModel::changesAboutToBeApplied, this,
                [this] {
        ...
        connect(d->model, &BusinessLayer::ScreenplayTextModel::changesApplied, this,
...
void ScreenplayTreatmentEdit::setVisibleTopLevelItemIndex(const QModelIndex& _index)
{
...
void ScreenplayTreatmentEdit::addReviewMark(const QColor& _textColor,
                                            ...
                                            bool _isRevision, bool _isAddition, bool _isRemoval)
{
    BusinessLayer::TextCursor cursor(textCursor());
...
void ScreenplayTreatmentEdit::setAutoReviewModeEnabled(bool _enabled)
{
    d->autoReviewMode.isEnabled = _enabled;
}

void ScreenplayTreatmentEdit::setAutoReviewMode(const QColor& _textColor,
                                                const QColor& _backgroundColor, bool _isRevision,
                                                bool _isTrackChanges)
{
...
void ScreenplayTreatmentEdit::insertFromMimeData(const QMimeData* _source)
{
    ...
    //
        ...
        textToInsert
            = fountainImporter
                  .screenplayText("\n" + TextHelper::removeControlCharacters(_source->text()))
                  .text;
    }

...
SceneHeadingHandler::SceneHeadingHandler(Ui::ScreenplayTreatmentEdit* _editor)
...
void SceneHeadingHandler::storeSceneParameters() const
{
    ...
    //     интро, а просто текст, который мы не можем разбить на части сцены, а соответственно и не
    //     будем сохранять
    //

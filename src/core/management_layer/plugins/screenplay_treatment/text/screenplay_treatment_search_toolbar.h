 ...
 */
class ScreenplayTreatmentSearchToolbar : public FloatingToolBar
{
    Q_OBJECT

public:
    explicit ScreenplayTreatmentSearchToolbar(QWidget* _parent = nullptr);
    ~ScreenplayTreatmentSearchToolbar() override;

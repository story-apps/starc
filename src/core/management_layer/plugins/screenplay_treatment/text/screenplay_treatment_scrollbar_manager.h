 ...
 */
class ScreenplayTreatmentScrollBarManager : public QObject
{
    Q_OBJECT

public:
    explicit ScreenplayTreatmentScrollBarManager(QAbstractScrollArea* _parent);
    ~ScreenplayTreatmentScrollBarManager() override;

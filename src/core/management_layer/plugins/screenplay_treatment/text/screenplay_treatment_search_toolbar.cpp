...
class ScreenplayTreatmentSearchToolbar::Implementation
{
public:
     ...
     */
    void showPopup(ScreenplayTreatmentSearchToolbar* _parent);
...
ScreenplayTreatmentSearchToolbar::Implementation::Implementation(QWidget* _parent)
...
void ScreenplayTreatmentSearchToolbar::Implementation::showPopup(
    ScreenplayTreatmentSearchToolbar* _parent)
{
...
ScreenplayTreatmentSearchToolbar::ScreenplayTreatmentSearchToolbar(QWidget* _parent)
    ...
    , d(new Implementation(this))
{
    ...
    connect(d->goToPreviousAction, &QAction::triggered, this,
            &ScreenplayTreatmentSearchToolbar::findPreviousRequested);
    ...
    connect(d->goToNextAction, &QAction::triggered, this,
            &ScreenplayTreatmentSearchToolbar::findNextRequested);
    ...
    connect(d->matchCaseAction, &QAction::toggled, this,
            &ScreenplayTreatmentSearchToolbar::findTextRequested);
    //
    ...
    connect(d->replace, &Button::clicked, this,
            &ScreenplayTreatmentSearchToolbar::replaceOnePressed);
...
QString ScreenplayTreatmentSearchToolbar::searchText() const
{
    return d->lastSearchText;
}

bool ScreenplayTreatmentSearchToolbar::isCaseSensitive() const
{
    return d->matchCaseAction->isChecked();
}

int ScreenplayTreatmentSearchToolbar::searchInType() const
{
    return d->popup->currentIndex().row();
}

QString ScreenplayTreatmentSearchToolbar::replaceText() const
{
    return d->replaceText->text();
}

bool ScreenplayTreatmentSearchToolbar::eventFilter(QObject* _watched, QEvent* _event)
{
    switch (_event->type()) {
    case QEvent::Resize: {
        if (_watched == parent()) {
...
void ScreenplayTreatmentSearchToolbar::processTextColorChange()
{
...
void ScreenplayTreatmentSearchToolbar::updateTranslations()
{
...
void ScreenplayTreatmentSearchToolbar::designSystemChangeEvent(DesignSystemChangeEvent* _event)
{

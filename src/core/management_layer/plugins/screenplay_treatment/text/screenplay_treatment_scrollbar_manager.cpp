#include "screenplay_treatment_scrollbar_manager.h"
...
class ScreenplayTreatmentScrollBarManager::Implementation
{
public:
...
ScreenplayTreatmentScrollBarManager::Implementation::Implementation(QWidget* _parent)
...
void ScreenplayTreatmentScrollBarManager::Implementation::updateTimelineGeometry()
{
...
void ScreenplayTreatmentScrollBarManager::Implementation::showTimelineAnimated()
{
...
ScreenplayTreatmentScrollBarManager::ScreenplayTreatmentScrollBarManager(
...
ScreenplayTreatmentScrollBarManager::~ScreenplayTreatmentScrollBarManager() = default;

void ScreenplayTreatmentScrollBarManager::initScrollBarsSyncing()
{
...
void ScreenplayTreatmentScrollBarManager::setModel(BusinessLayer::ScreenplayTextModel* _model)
{
    if (d->model == _model) {
        return;
    }
...
void ScreenplayTreatmentScrollBarManager::setScrollBarVisible(bool _visible)
{
    if (_visible) {
...
bool ScreenplayTreatmentScrollBarManager::eventFilter(QObject* _watched, QEvent* _event)
{
    //

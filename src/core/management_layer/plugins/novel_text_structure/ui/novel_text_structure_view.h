...
class NovelTextStructureView : public AbstractNavigator, public IDocumentView
{
    Q_OBJECT

public:
    explicit NovelTextStructureView(QWidget* _parent = nullptr);
    ~NovelTextStructureView() override;

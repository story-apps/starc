 ...
 */
class MANAGER_PLUGIN_EXPORT NovelTextStructureManager : public QObject, public IDocumentManager
{
    Q_OBJECT
...
public:
    explicit NovelTextStructureManager(QObject* _parent = nullptr);
    ~NovelTextStructureManager() override;

...
class AudioplayStatisticsStructureView::Implementation
{
public:
...
AudioplayStatisticsStructureView::Implementation::Implementation(QWidget* _parent)
...
AudioplayStatisticsStructureView::AudioplayStatisticsStructureView(QWidget* _parent)
    ...
    , d(new Implementation(this))
{
    ...
    connect(d->backIcon, &AbstractLabel::clicked, this,
            &AudioplayStatisticsStructureView::backPressed);
    connect(d->backText, &AbstractLabel::clicked, this,
            &AudioplayStatisticsStructureView::backPressed);
    connect(d->reports, &Tree::clicked, this,
            &AudioplayStatisticsStructureView::currentReportIndexChanged);
    connect(d->reports, &Tree::doubleClicked, this,
            &AudioplayStatisticsStructureView::currentReportIndexChanged);
    connect(this, &AudioplayStatisticsStructureView::currentReportIndexChanged, this, [this] {
        QSignalBlocker signalBlocker(d->plots);
        d->plots->setCurrentIndex({});
    });
    connect(d->plots, &Tree::clicked, this,
            &AudioplayStatisticsStructureView::currentPlotIndexChanged);
    connect(d->plots, &Tree::doubleClicked, this,
            &AudioplayStatisticsStructureView::currentPlotIndexChanged);
    connect(this, &AudioplayStatisticsStructureView::currentPlotIndexChanged, this, [this] {
        QSignalBlocker signalBlocker(d->reports);
        d->reports->setCurrentIndex({});
    });
}

AudioplayStatisticsStructureView::~AudioplayStatisticsStructureView() = default;

QWidget* AudioplayStatisticsStructureView::asQWidget()
{
    return this;
}

void AudioplayStatisticsStructureView::setTitle(const QString& _title)
{
    d->backText->setText(_title);
}

void AudioplayStatisticsStructureView::updateTranslations()
{
...
void AudioplayStatisticsStructureView::designSystemChangeEvent(DesignSystemChangeEvent* _event)
{

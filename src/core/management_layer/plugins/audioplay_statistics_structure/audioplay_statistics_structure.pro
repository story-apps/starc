...
TARGET = audioplaystatisticsstructureplugin
...
HEADERS += \
    audioplay_statistics_structure_manager.h \
    audioplay_statistics_structure_view.h

SOURCES += \
    audioplay_statistics_structure_manager.cpp \
    audioplay_statistics_structure_view.cpp

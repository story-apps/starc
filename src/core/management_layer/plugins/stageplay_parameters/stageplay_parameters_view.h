 ...
 */
class StageplayParametersView : public Widget, public IDocumentView
{
    Q_OBJECT

public:
    explicit StageplayParametersView(QWidget* _parent = nullptr);
    ~StageplayParametersView() override;

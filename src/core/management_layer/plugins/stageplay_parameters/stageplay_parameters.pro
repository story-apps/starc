...
TARGET = stageplayparametersplugin
...
HEADERS += \
    stageplay_parameters_manager.h \
    stageplay_parameters_view.h

SOURCES += \
    stageplay_parameters_manager.cpp \
    stageplay_parameters_view.cpp

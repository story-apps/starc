...
QRectF ComicBookTextStructureDelegate::Implementation::paintItemDuration(
    ...
    QPainter* _painter, const QStyleOptionViewItem& _option, const QModelIndex& _index) const
{
    ...
    const std::chrono::seconds duration{
        //        _index.data(ComicBookTextModelFolderItem::FolderDurationRole).toInt()
    };
                                                                ...
                                                                const QModelIndex& _index) const
{
    ...
    //
    const std::chrono::seconds duration{
        //        _index.data(ComicBookTextModelPanelItem::SceneDurationRole).toInt()
    };
...
void ComicBookTextStructureDelegate::Implementation::paintText(QPainter* _painter,
                                                               const QStyleOptionViewItem& _option,
                                                               const QModelIndex& _index) const
{
    using namespace BusinessLayer;
...
QSize ComicBookTextStructureDelegate::Implementation::textSizeHint(
    const QStyleOptionViewItem& _option, const QModelIndex& _index) const
{

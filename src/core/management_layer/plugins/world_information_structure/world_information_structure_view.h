...
class WorldInformationStructureView : public AbstractNavigator, public IDocumentView
{
    Q_OBJECT

public:
    explicit WorldInformationStructureView(QWidget* _parent = nullptr);
    ~WorldInformationStructureView() override;

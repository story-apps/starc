...
HEADERS += \
    world_information_structure_manager.h \
    world_information_structure_view.h

SOURCES += \
    world_information_structure_manager.cpp \
    world_information_structure_view.cpp

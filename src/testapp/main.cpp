...
int main(int argc, char* argv[])
{
    ...
    QVector<ChatMessage> messages = {
        { QDateTime(QDate(2020, 12, 13), QTime(14, 28, 11)), "Пока не понял. Где он вводит имайл?",
          User("Mikhail Galkin") },
        ...
        { QDateTime(QDate(2020, 12, 14), QTime(11, 39, 11)),
          "Привет. Ок. В выходные что-то отдыхалось так хорошо. Так что ничего не делал. Сегодня "
          "прикину оценку и по апихе потрещим.",
          User("Mikhail Galkin") },
        ...
        { QDateTime(QDate(2020, 12, 14), QTime(12, 3, 11)), "??? за что?", User("Mikhail Galkin") },
